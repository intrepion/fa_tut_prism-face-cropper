...
For this project, the code layer in this repo owns `validate_face_selection_map`, `build_face_crop_plan`, and `format_face_crop_summary`, and adapter layer must not reimplement them.
